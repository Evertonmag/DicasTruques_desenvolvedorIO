...
namespace EfCore.Tips
{
    public class Program
    {
        ...
        static void ToView()
        {
            ...
            var deprtamentos = Enumerable.Range(1, 10)
            ...
            db.Departamentos.Add(departamento);
            db.Departamentos.AddRange(deprtamentos);
            db.SaveChanges();
        ...
        static void SemChavePrimaria()
        {
            ...
            var usuariosFuncoes = db.UsuarioFuncoes.Where(p=>p.UsuarioId == Guid.NewGuid()).ToArray();
        }
